...
func (m *mockExchangeService) UpdateTicker(ctx context.Context, assetType asset.Item) (*ticker.Price, error) {
	return nil, nil
}
func (m *mockExchangeService) GetWithdrawalsHistory(ctx context.Context, p currency.Pair, a asset.Item) ([]exchanges.WithdrawalHistory, error) {
	return nil, nil
}
